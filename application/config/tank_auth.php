...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'AVI Transportation Service, LLC ';
...
$config['recaptcha_public_key'] = '6LfrHcoSAAAAANVohep-CkVqb8ZHLotFVQKj7pcb';
$config['recaptcha_private_key'] = '6LfrHcoSAAAAAOf7eQZaioqev-SJdyeJ8TdDTdGj';
